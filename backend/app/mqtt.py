...
class MQTT:
    ...
    sub_topics = [("620160532_pub", 1), ("620160532", 1), ("620160532_sub", 1)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620160532", self.gdp)
        self.client.message_callback_add("620160532_sub", self.toggle)
